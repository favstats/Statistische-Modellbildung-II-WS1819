...
REGRESSION
  /DEPENDENT lebensz_org.2004
  /METHOD=ENTER gesund_org.2003 lebensz_org.2003.

REGRESSION
  /DEPENDENT gesund_org.2004
  /METHOD=ENTER gesund_org.2003 lebensz_org.2003.
...
compute ageschl_int = alter0 * geschl_rec .
...
REGRESSION
  /DEPENDENT einkommen
  /METHOD=ENTER alter0 geschl_rec.
...
REGRESSION
  /DEPENDENT einkommen
  /METHOD=ENTER alter0 geschl_rec ageschl_int.
