...
Bezüglich der Y-Werteverteilung besteht kein Problem, in jeder Gruppe sind mehr als 10% der Fälle vertreten. Eine unvollständigkeit der Informationen liegt bezüglich der SPD-Wähler und der Gewerkschaftszugehörigkeit, der Konfession Evangelisch und des Geschlechts (geschl_rec) nicht vor. Wenn wir uns die absoluten Verteilungen dieser Merkmalskombinationen anschauen stellen wir fest, dass keine Nullstellen vorkommen auch keine auffällig schwachbesetzten Zellen. Bei der Merkmalskombination SPD-Wähler und Bildung (bildung_rec) scheint es aber ein Problem zu geben. Die Kategorie 0 der Variable bildung_rec weißt sehr schwache Werte auf. Allgemein gibt es kaum Fälle in der Kategorie 0, der Variable bildung_rec. Es liegt keine vollständige Seperation vor.
