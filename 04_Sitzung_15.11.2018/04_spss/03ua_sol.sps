...
*siops.
COMPUTE prestige_befragter = V112.

REGRESSION
  /DEPENDENT prestige_befragter
  /METHOD=ENTER bildung_rec
  /SCATTERPLOT=(*RESID, bildung_rec).
...
REGRESSION
  ...
  /METHOD=ENTER alter0
  /SAVE RESID ZRESID 
  /SCATTERPLOT=(*RESID , alter0)
  /SCATTERPLOT=(*ZRESID , alter0).
...
COMPUTE ZRE_1_ABS = ABS(ZRE_1).
CORR alter0 ZRE_1_ABS.
