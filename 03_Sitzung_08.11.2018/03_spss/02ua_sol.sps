...
DESCRIPTIVES VAR= v84 alter0 bildung_rec einkommen
/SAVE.


RENAME VARIABLES (ZV84 Zalter0 Zbildung_rec Zeinkommen= alter_z alter0_z bildung_z einkommen_z).
...
FREQUENCIES VARIABLES=alter_z alter0_z
  /STATISTICS=STDDEV MINIMUM MAXIMUM MEAN MEDIAN SKEWNESS KURTOSIS.
...
REGRESSION
  /DEPENDENT einkommen
  /METHOD=ENTER alter0 bildung_rec V124  
                V842 V836 V712 V660 V661  
                V663 V664 V665 V666 V667 
                V849 V662 V668 V669.
